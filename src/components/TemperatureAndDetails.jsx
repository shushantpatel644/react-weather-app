    ...
    return <div>
        ...
        <div className="flex flex-row items-center justify-between text-white py-3">
            <img
                ...
                alt=""
                className="w-20" />
            <p className="text-5xl">{`${feels_like.toFixed()}°`}</p>
        ...
        <div className="flex flex-row items-center justify-center space-x-2 text-white text-sm py-3">
            ...
            <UilSun />
            <p className="font-light">High: <span className="font-medium ml-1"> {formatToLocalTime(temp_max, timezone, "hh:mm a")}</span>
            </p>
            <p className="font-light">|</p>
            ...
            <p className="font-light">
                Low: <span className="font-medium ml-1"> {formatToLocalTime(temp_min, timezone, "hh:mm a")}</span>
            </p>
        </div>
    </div>
}
